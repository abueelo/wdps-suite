<script lang="ts">
  ...
  // output). The actual content (title/break/photo, caption, border
  // guide) lives in Stage.svelte, shared with the control panel's own
  // preview so the two are guaranteed to look the same, not just similar.
