// Pulls a competition straight from upload-portal's own API — presenter
...
export async function importUploadPortalCompetition(competitionId: string, startOrder: number): Promise<PresenterImage[]> {
